...
- **Run Code:** You can run and test code using [JupyterLab](https://jupyter.org/) or VS Code.
...
To begin, head to **[Week 0 – Getting Started](python_course/week_0/software_list.md)** and install the required tools.
